...
docs_cn=(master refactor-migration-docs release-5.1 release-5.0 release-4.0 release-3.1 release-3.0 release-2.1)
docs=(master refactor-migration-docs release-5.1 release-5.0 release-4.0 release-3.1 release-3.0 release-2.1)
